  ...
  return (
    <React.Fragment>
      ...
      <Section className="py-24">
        <iframe
          className="w-full"
          src="https://ko-fi.com/streamalerts/goaloverlay/sa_5a6383bc-8611-4e96-a338-dd2b5fc61409"
        />
        ...
        <div className="flex flex-col md:flex-row gap-16">
          <div className="w-full md:w-[70%] space-y-8 text-base md:text-xl">
            ...
            <div className="space-y-2">
              ...
              <p>
                We are dedicated to providing high-quality content and a
                seamless viewing experience for our users. However, maintaining
                a streaming website requires significant resources, including
                servers, bandwidth, and technology.
              </p>
              <p>
                ...
                better servers and technology upgrades. With your support, we
                can continue to provide the best streaming content for you and
            ...
            <div className="space-y-2">
              ...
              <p>
                You can either donate using the form or go to{" "}
                <a
          ...
          <div className="w-full md:w-[30%] h-[40rem] !mt-8">
            <iframe
