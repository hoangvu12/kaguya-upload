      ...
      <div className="w-full md:w-[70%] space-y-8 text-base md:text-xl">
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            running, as well as improve the overall user experience with better
            servers and technology upgrades. With your support, we can continue
            to provide the best streaming content for you and the entire
            community.
          </p>
          <p>
