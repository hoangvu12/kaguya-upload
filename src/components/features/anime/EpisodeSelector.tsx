        ...
        <div
          className={classNames(
            showType === EpisodeShowType.Grid
              ? "2xl:grid-cols-9 xl:grid-cols-8 lg:grid-cols-7 md:grid-cols-6 sm:grid-cols-5 grid-cols-4"
              : "2xl:grid-cols-5 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1",
            "mt-8 grid gap-4"
          )}
        >
